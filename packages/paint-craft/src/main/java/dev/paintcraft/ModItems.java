...
public final class ModItems {
    ...
    public static final DeferredItem<StampItem> STAMP = ITEMS.register("stamp",
        () -> new StampItem(new Item.Properties().stacksTo(64)));

    public static final DeferredItem<EraserItem> ERASER = ITEMS.register("eraser",
        () -> new EraserItem(new Item.Properties().stacksTo(1).durability(0)));
